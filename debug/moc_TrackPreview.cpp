...
**
** Created: Fri Feb 1 10:13:05 2013
...
static const char qt_meta_stringdata_TrackPreview[] = {
    "TrackPreview\0\0trackPrint()\0previewClose()\0"
};

const QMetaObject TrackPreview::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrackPreview,
      qt_meta_data_TrackPreview, 0 }
};
...
void *TrackPreview::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::TrackPreviewClass"))
        return static_cast< Ui::TrackPreviewClass*>(const_cast< TrackPreview*>(this));
...
int TrackPreview::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: trackPrint(); break;
        case 1: previewClose(); break;
        default: ;
        }
        _id -= 2;
    }
